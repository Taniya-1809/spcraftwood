...
function loadAllGalleryImages() {
  ...
  allGalleryImages.forEach((image, index) => {
    ...
    // Gallery items are clickable but image popup is disabled
    // Uncomment below to enable image popup on click
...
// Image Popup functionality (currently disabled - uncomment to enable)
